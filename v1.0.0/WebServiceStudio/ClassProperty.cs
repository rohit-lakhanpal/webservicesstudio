    ...
    internal class ClassProperty : TreeNodeProperty
    {
        ...
        protected override void CreateChildren()
        {
            ...
            if (this.OkayToCreateChildren())
            {
                ...
                {
                    var val = info.GetValue(this.val, null);
                ...
                foreach (var info2 in this.Type.GetFields(BindingFlags.Public | BindingFlags.Instance))
                {
                    var obj3 = info2.GetValue(this.val);
        ...
        public override object ReadChildren()
        {
            ...
            foreach (var info2 in this.Type.GetFields(BindingFlags.Public | BindingFlags.Instance))
            {
                var node2 = base.TreeNode.Nodes[num++];
