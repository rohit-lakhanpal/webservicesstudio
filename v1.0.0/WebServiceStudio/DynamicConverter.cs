namespace WebServiceStudio
{
    ...
    internal class DynamicConverter : TypeConverter
    {
        ...
        static DynamicConverter()
        {
            ...
            foreach (var handler in Configuration.MasterConfig.TypeConverters)
            {
                var type = Type.GetType(handler.TypeName);
                if (type == null)
                {
                ...
                {
                    var type2 = Type.GetType(handler.Handler);
                    if (type2 == null)
                    {
        ...
        {
            object obj2 = null;
            var containedType = GetContainedType(context);
